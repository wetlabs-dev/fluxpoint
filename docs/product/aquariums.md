...
Aquarium overview pages also include a compact Aquarium Health card from Aquarium Intelligence. The card shows a qualitative state, confidence, assessment freshness, deterministic summary, top attention factors, and a refresh action. Detailed health, parameter trends, timeline insights, and assessment history live on the private Intelligence workspace tab.
