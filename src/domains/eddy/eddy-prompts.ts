...
const actionInstructions: Record<EddyAction, string> = {
  ...
  "health-explanation": "Explain the supplied deterministic Aquarium Intelligence assessment, parameter analyses, and timeline insights. Cite supplied evidence and dates, distinguish measured facts from deterministic interpretation, call out missing data, and never claim causation, diagnosis, or veterinary certainty."
};
