...
export const eddyFeatures: Record<EddyFeatureKey, EddyFeatureDefinition> = {
  ...
  SPECIES_MAGIC_FILL: { ...feature("SPECIES_MAGIC_FILL", "Species Magic Fill", "Draft complete taxonomy, references, aliases, salinity, care ranges, and regional context for review.", 6, 30, 300, "MEDIUM", ["species-magic-fill"]), userLimitEnv: "EDDY_SPECIES_MAGIC_FILL_DAILY_USER_LIMIT" },
