        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid gap-3 sm:grid-cols-4">
              ...
              <Fact label="Aquarium" value={project.aquarium?.name ?? "Not linked"} />
