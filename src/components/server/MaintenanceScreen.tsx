  ...
  return (
    <main className="grid min-h-screen place-items-center bg-background px-4 py-12">
      <div className="w-full max-w-xl rounded-xl border border-border bg-card p-8 text-center shadow-soft">
        ...
        <div className="mt-5 flex items-center justify-center gap-2 text-sm font-semibold uppercase tracking-[0.18em] text-muted-foreground"><FluxpointLogoTile size={28} className="rounded-md p-0.5" /> Fluxpoint</div>
