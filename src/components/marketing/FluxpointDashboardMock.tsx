    ...
    <div className="rounded-lg border border-[#cfded5] bg-white/65 p-4 shadow-[0_18px_60px_rgba(11,43,49,0.12)] backdrop-blur">
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <h2 className="mt-1 text-2xl font-bold text-[#103f48]">Tank dashboard</h2>
        </div>
        <div className="rounded-md bg-[#123f46] px-3 py-2 text-sm font-bold text-white">3 active tanks</div>
      </div>
