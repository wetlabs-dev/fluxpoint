    ...
    <main className="min-h-screen bg-[#f7f3e8] text-[#07373b]">
      <section className="mx-auto max-w-5xl px-5 py-8">
        ...
        <header className="mt-4 overflow-hidden rounded-3xl border border-[#b8d4d4] bg-white shadow-[0_20px_60px_rgba(6,54,57,0.12)]">
          ...
          <div className="grid gap-3 p-5 sm:grid-cols-3"><Info label="Volume" value={aquarium.volume} /><Info label="Inhabitants" value={`${aquarium.inhabitants.length}`} /><Info label="Plants" value={`${aquarium.plants.length}`} /></div>
        </header>
