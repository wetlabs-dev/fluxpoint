...
export const manualSections: ManualSection[] = [
  ...
  },
  {
    ...
    purpose: "Account settings manage profile details, timezone, notification preferences, email preferences, and push devices.",
    howTo: [
    ...
    notes: ["Push notifications are optional; Fluxpoint remains usable without browser push support."]
  },
  {
